      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Welcome back, {user.firstName}! Manage your orders and account.</p>
          </div>
                ...
                <DropdownMenuLabel className="font-normal p-3 bg-gray-50 rounded-lg mb-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col space-y-1">
                      ...
                      {user.designation && (
                        <p className="text-xs leading-none text-blue-600 font-medium bg-blue-50 px-2 py-1 rounded">
                          {user.designation}
                        </p>
                      )}
                      {user.department && (
