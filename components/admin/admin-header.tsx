      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Welcome back, {user.firstName}! Manage your organization.</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-12 w-12 rounded-full hover:bg-gray-100 transition-colors focus:ring-2 focus:ring-blue-500 focus:outline-none">
                  <Avatar className="h-12 w-12 border-2 border-gray-200">
                    <AvatarImage src={user.profilePhoto || ""} alt={`${user.firstName} ${user.lastName}`} />
                    <AvatarFallback className="bg-red-100 text-red-700 font-semibold text-lg">
                ...
                <DropdownMenuLabel className="font-normal p-3 bg-gray-50 rounded-lg mb-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col space-y-1">
                      ...
                      {user.designation && (
                        <p className="text-xs leading-none text-red-600 font-medium bg-red-50 px-2 py-1 rounded">
                          {user.designation}
                        </p>
                      )}
                      {user.department && (
